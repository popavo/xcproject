...
@class PBXBookmarkGroup, PBXBuildSettingsDictionary, PBXBuildStyle, PBXCodeSenseManager, PBXExecutable, PBXFileReference, PBXGroup, PBXLogOutputString,
    PBXProjectIndex, PBXTarget, XCArchiveFormat, XCBreakpointsBucket, XCBuildOperation, XCConfigurationList, XCFileSystemWatcher, XCRoots,
    XCSourceControlManager;
