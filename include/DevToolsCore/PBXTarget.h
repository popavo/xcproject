...
#import <DevToolsCore/XCConfigurationInspectables.h>
...
-(void)_appendUpgradeLogFormat:(NSString*)arg1 arguments:(va_list)arg2 attributes:(id)arg3 NS_FORMAT_FUNCTION(1,0);
-(id)indexedFileList;
